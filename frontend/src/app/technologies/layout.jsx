...
export const metadata = {
  title:
    "Technologies & Expertise | Reliable, Scalable & Secure Apps | MommentX",
  description:
  ...
  openGraph: {
    ...
    description:
      "Discover the reliable, scalable, and secure technologies we use to build world-class web and mobile applications.",
...
export default function TechnologiesLayout({ children }) {
  const schema = {
    ...
    description:
      "Technologies we use to build reliable, scalable, and secure applications.",
    url: "https://mommentx.space/technologies",
    publisher: {
      "@type": "Organization",
      name: "MommentX",
