...
import {
  ShoppingCart, Users, Package, BarChart3, UserPlus, CreditCard,
  AlertTriangle, MessageSquareX, ClipboardList, TrendingDown,
  Zap, History, Bell, Wallet, PieChart, Building2,
  Mail, Phone, MessageCircle, Send,
  Globe, Moon, Sun, Menu, X, ArrowRight, Play,
  LayoutDashboard, FileText, Settings, ChevronUp
} from 'lucide-react';
import './erp.css';
...
const translations = {
  en: {
    ...
    heroSub: 'Stop losing WhatsApp and Facebook orders. OrderFlow ERP brings all your orders, customers, and inventory into one powerful system — so nothing falls through the cracks.',
    ...
    problemSub: 'If you\'re managing your shop through WhatsApp and Facebook, you\'re likely facing these costly problems:',
    problems: [
      {
    ...
    solutionSub: 'OrderFlow ERP is a complete business management system designed specifically for Sri Lankan shop owners.',
    solutions: [
      {
    ...
    dashSub: 'A powerful dashboard that gives you instant insights into your business performance.',
    dashStats: [
    ...
    dashSidebarItems: ['Dashboard', 'Orders', 'Customers', 'Inventory', 'Reports', 'Settings'],

    // Features
    featuresLabel: 'Features',
    featuresTitle: 'Built for Speed and Simplicity',
    featuresSub: 'Every feature is designed to save you time and help you grow your business.',
    features: [
      {
    ...
    // Coming Soon
    comingSoonTitle: 'This platform is coming soon for small business owners in Sri Lanka',
    comingSoonSub: 'Be among the first to transform how you manage your business. Join the waitlist today.',
    comingSoonBtn: 'Join the Waitlist',

    // Contact
    contactLabel: 'Contact Us',
    contactTitle: 'Get in Touch',
    contactSub: 'Have questions? We\'d love to hear from you. Send us a message and we\'ll respond as soon as possible.',
  ...
  si: {
    ...
    heroSub: 'WhatsApp සහ Facebook orders මඟ හැරෙනවාද? OrderFlow ERP මඟින් ඔබේ සියලුම orders, customers සහ inventory එක system එකකට ගෙනත් කිසිම දෙයක් මඟ නොහැරෙන බව සහතික කරයි.',
    ...
    problemSub: 'ඔබ WhatsApp සහ Facebook හරහා ව්‍යාපාරය කළමනාකරණය කරනවා නම්, මෙම ගැටලු ඔබට බලපානවා ඇති:',
    problems: [
      {
    ...
    solutionSub: 'OrderFlow ERP ශ්‍රී ලංකාවේ shop owners සඳහා විශේෂයෙන් නිර්මාණය කළ සම්පූර්ණ business management system එකකි.',
    solutions: [
      {
        title: 'Order Management System',
    ...
    dashSub: 'ඔබේ business performance ගැන ක්ෂණික insights ලබා දෙන බලවත් dashboard එකක්.',
    dashStats: [
    ...
    featuresSub: 'සෑම feature එකක්ම ඔබේ කාලය ඉතිරි කිරීමට සහ ව්‍යාපාරය වර්ධනය කිරීමට නිර්මාණය කර ඇත.',
    features: [
      {
        title: 'Real-time Order Tracking',
    ...
    // Coming Soon
    comingSoonTitle: 'මෙම platform එක ඉක්මනින් ශ්‍රී ලංකාවේ කුඩා ව්‍යාපාරිකයින්ට ලබා දෙනවා',
    comingSoonSub: 'ඔබේ ව්‍යාපාරය manage කරන ආකාරය වෙනස් කරන පළමු අය අතරට එන්න. අද waitlist එකට එකතු වන්න.',
    comingSoonBtn: 'Waitlist එකට එකතු වන්න',

    // Contact
    contactLabel: 'සම්බන්ධ වන්න',
    contactTitle: 'අපව සම්බන්ධ කරගන්න',
    contactSub: 'ප්‍රශ්න තිබේද? ඔබගෙන් අසන්න අපි කැමතියි. අපට message එකක් යවන්න, ඉක්මනින් පිළිතුරු දෙන්නම්.',
...
const ERP = () => {
  ...
  useEffect(() => {
    ...
    const obs = new IntersectionObserver(
      (entries) => entries.forEach(e => { if (e.isIntersecting) { e.target.classList.add('erp-visible'); obs.unobserve(e.target); } }),
  ...
  /* ---- Sidebar icon map ---- */
  const sidebarIcons = [LayoutDashboard, ShoppingCart, Users, Package, FileText, Settings];
  ...
  /* ---- Solution icons ---- */
  const solutionIcons = [ShoppingCart, Users, Package, BarChart3, UserPlus, CreditCard];

  /* ---- Feature icons ---- */
  const featureIcons = [Zap, History, Bell, Wallet, PieChart, Building2];

  /* ---- Problem icons ---- */
  const problemIcons = [MessageSquareX, ClipboardList, AlertTriangle, TrendingDown];
  ...
  return (
    <div className={`erp-page ${darkMode ? 'erp-dark' : ''}`}>
        ...
        <div className="erp-container">
          <div className="erp-nav-inner">
            ...
            <div className="erp-nav-logo" onClick={() => scrollTo('erp-hero')}>
              ...
              OrderFlow <span style={{ fontWeight: 400, opacity: 0.6, marginLeft: 4 }}>ERP</span>
            </div>

            {/* Desktop links */}
            <div className="erp-nav-links">
              {navLinks.map(link => (
                <button key={link.id} className="erp-nav-link" onClick={() => scrollTo(link.id)}>
                  {link.label}
                </button>
              ))}
            </div>
            ...
            <div className="erp-nav-controls">
              ...
              <button className="erp-nav-cta" onClick={() => scrollTo('erp-contact')}>
                {t.navCta}
              </button>
              {/* Hamburger (mobile) */}
              <button
      ...
      {mobileMenu && (
        <div className="erp-mobile-menu">
          ...
          <div className="erp-mobile-controls">
            <button className="erp-nav-icon-btn" onClick={() => setLang(p => p === 'en' ? 'si' : 'en')}>
              <Globe size={20} />
            </button>
            <button className={`erp-nav-icon-btn ${darkMode ? 'active' : ''}`} onClick={() => setDarkMode(p => !p)}>
        ...
        <div className="erp-container">
          <div className="erp-hero-content erp-animate erp-visible">
            ...
            <div className="erp-hero-buttons">
              <button className="erp-btn-primary" onClick={() => scrollTo('erp-contact')}>
      ...
      <section className="erp-problem" id="erp-problem">
        <div className="erp-container">
          <div className="erp-problem-header erp-animate">
            ...
            <p className="erp-section-subtitle" style={{ margin: '0 auto' }}>{t.problemSub}</p>
          </div>
          <div className="erp-problem-grid">
            {t.problems.map((item, i) => {
              const Icon = problemIcons[i];
              return (
                <div key={i} className={`erp-problem-card erp-animate erp-animate-delay-${i + 1}`}>
                  <div className="erp-problem-icon"><Icon size={24} /></div>
                  <h3>{item.title}</h3>
                  <p>{item.desc}</p>
                </div>
              );
        ...
        <div className="erp-container">
          ...
          <div className="erp-solution-grid">
            {t.solutions.map((item, i) => {
              ...
              return (
                <div key={i} className={`erp-solution-card erp-animate erp-animate-delay-${i % 3 + 1}`}>
                  <div className="erp-solution-icon"><Icon size={24} /></div>
                  <h3>{item.title}</h3>
                  <p>{item.desc}</p>
                </div>
              );
      ...
      <section className="erp-dashboard-section" id="erp-dashboard">
        <div className="erp-hero-glow erp-hero-glow-1" style={{ top: '10%', right: '5%', opacity: 0.2 }} />
        <div className="erp-container">
          ...
          <div className="erp-dashboard-mockup erp-animate">
            ...
            <div className="erp-dash-topbar">
              <div className="erp-dash-topbar-left">
                ...
                <div className="erp-dash-topbar-url">app.orderflow.lk/dashboard</div>
              </div>
            </div>
            ...
            <div className="erp-dash-body">
              ...
              <div className="erp-dash-sidebar">
                {t.dashSidebarItems.map((item, i) => {
                  ...
                  return (
                    <div key={i} className={`erp-dash-sidebar-item ${i === 0 ? 'active' : ''}`}>
                      <Icon size={16} /> {item}
                    </div>
                  );
                })}
              ...
              <div className="erp-dash-main">
                <div className="erp-dash-stats">
                  {t.dashStats.map((stat, i) => (
                    <div key={i} className="erp-dash-stat-card">
                      ...
                      <div className={`erp-dash-stat-value ${i === 0 ? 'green' : i === 2 ? 'yellow' : i === 3 ? 'red' : ''}`}>
                        {stat.value}
                      </div>
                      <div className={`erp-dash-stat-change ${stat.up ? 'up' : 'down'}`}>
                        {stat.up ? <ChevronUp size={12} /> : <TrendingDown size={12} />} {stat.change}
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="erp-dash-chart">
                  ...
                  <div className="erp-dash-chart-bars">
                    {chartBars.map((h, i) => (
                      <div key={i} className="erp-dash-chart-bar" style={{ height: `${h}%` }} />
                    ))}
                  </div>
                  <div className="erp-dash-chart-labels">
                    {chartLabels.map((label, i) => (
                      <div key={i} className="erp-dash-chart-label">{label}</div>
                    ))}
                  </div>
                </div>
              </div>
        ...
        <div className="erp-container">
          ...
          <div className="erp-features-grid">
            {t.features.map((item, i) => {
              ...
              return (
                <div key={i} className={`erp-feature-card erp-animate erp-animate-delay-${i % 3 + 1}`}>
                  <div className="erp-feature-card-icon"><Icon size={22} /></div>
                  <h3>{item.title}</h3>
                  <p>{item.desc}</p>
                </div>
              );
      ...
      <section className="erp-coming-soon" id="erp-coming-soon">
        <div className="erp-coming-soon-content erp-animate">
          ...
          <p>{t.comingSoonSub}</p>
          <button className="erp-btn-outline" onClick={() => scrollTo('erp-contact')}>
      ...
      <section className="erp-contact" id="erp-contact">
        <div className="erp-container">
          ...
          <div className="erp-contact-grid erp-animate">
            {/* Form */}
            <form className="erp-contact-form" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="erp-contact-info">
              <div className="erp-contact-info-item">
                <div className="erp-contact-info-icon"><Mail size={22} /></div>
              ...
              <div className="erp-contact-info-item">
                <div className="erp-contact-info-icon"><Phone size={22} /></div>
                <div className="erp-contact-info-text">
              ...
              <div className="erp-contact-info-item">
                <div className="erp-contact-info-icon"><MessageCircle size={22} /></div>
                <div className="erp-contact-info-text">
                  <h4>{t.contactWhatsAppLabel}</h4>
                  <p>+94 77 123 4567</p>
                </div>
              </div>
            </div>
        ...
        <div className="erp-container">
          <div className="erp-footer-inner">
            ...
            <div className="erp-footer-social">
              <a className="erp-footer-social-icon" href="#" aria-label="Facebook"><FacebookIcon size={18} /></a>
              <a className="erp-footer-social-icon" href="#" aria-label="WhatsApp"><MessageCircle size={18} /></a>
              <a className="erp-footer-social-icon" href="#" aria-label="GitHub"><GithubIcon size={18} /></a>
            </div>
          </div>
